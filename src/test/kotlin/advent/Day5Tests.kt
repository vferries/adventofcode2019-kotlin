...
class Day5Tests {
    ...
    fun `Part 1 - Simple matching example`() {
        ...
        val intCode = IntCode(list, mutableListOf())
        intCode.compute()
    ...
    fun `Part 2 - 1 if equals 8`() {
        ...
        val intCode = IntCode(list.toMutableList(), mutableListOf(8))
        intCode.compute()
        assertEquals(1, intCode.outputs.last())
        val intCode2 = IntCode(list.toMutableList(), mutableListOf(1))
        intCode2.compute()
    ...
    fun `Part 2 - 1 if less than 8`() {
        ...
        val intCode = IntCode(list.toMutableList(), mutableListOf(1))
        intCode.compute()
        assertEquals(1, intCode.outputs.last())
        val intCode2 = IntCode(list.toMutableList(), mutableListOf(12))
        intCode2.compute()
        assertEquals(0, intCode2.outputs.last())
    }
    ...
    fun `Part 2 - jump test 1`() {
        ...
        val intCode = IntCode(list.toMutableList(), mutableListOf(0))
        intCode.compute()
    ...
    fun `Part 2 - complete example`() {
        ...
        val intCode = IntCode(list.toMutableList(), mutableListOf(5))
        intCode.compute()
        assertEquals(999, intCode.outputs.last())
        val intCode2 = IntCode(list.toMutableList(), mutableListOf(8))
        intCode2.compute()
        assertEquals(1000, intCode2.outputs.last())
        val intCode3 = IntCode(list.toMutableList(), mutableListOf(12))
        intCode3.compute()
